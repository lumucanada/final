---
title: "Factors like the satisfaction of the federal government under Justin Trudeau, feeling about Justin Trudeau, gender, age and the province living in influence the 2019 canadian federal election"
author: "LU MU"
date: "2020/12/5"
output: pdf_document
---
...
## Model 2
The model 2 we use is logistic regression. We're interested in variables, like the satisfaction of the federal government, feeling about Justin Trudeau, gender, age and province living in influence a person's decision to vote the Liberal Party. The response variable is whether a person decides to vote for the Conservative Party, and it is a categorical variable with two levels: 0 means not voting for the Conservative Party and 1 means voting for the Conservative Party. The explanatory variables are the satisfaction of the federal government, feeling about Justin Trudeau, gender, age and province living in these 5 variables. They are also categorical variables and the benefits of using categorical variable is that they can represent the data better and have a more intuitive interpretation for displaying results.
